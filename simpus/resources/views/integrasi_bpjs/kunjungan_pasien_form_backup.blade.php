                              ...
                              <div class="form-row">
                                <div class="form-group col-md-12">
                                  ...
                                  <input type="text" class="form-control mb-1" name="no_rawat" id="no_rawat" readonly=""
                                    value="{{$poli->pendaftaran->no_rawat}}">
                                  <input type="hidden" class="form-control mb-1" name="pendaftaran_id" id="pendaftaran_id" readonly=""
                                    value="{{$poli->pendaftaran->id}}">
                                  <input type="hidden" class="form-control mb-1" name="poli_id" id="poli_id" readonly=""
                                    value="{{$poli->pendaftaran->poli->id}}">
                                </div>
                              </div>
                              <div class="form-row">
                                <div class="form-group col-md-12">
                                  <label class="form-label">Dokter Penanggung Jawab <span>*</span></label>
                                  <input type="hidden" name="kdDokter" id="kdDokter" value="{{ $poli->pendaftaran->id_dokter }}">
                                  <input type="text" class="form-control mb-1" name="nama_dokter" id="nama_dokter" readonly=""
                                    value="{{$poli->pendaftaran->nama_penanggung_jawab}}">
                                </div>
                              </div>
                              <div class="form-row">
                                <div class="form-group col-md-12">
                                  ...
                                  <input type="text" class="form-control mb-1" name="nama_poli" id="nama_poli" readonly=""
                                    value="{{$poli->pendaftaran->poli->nama_poli}}">
                                </div>
                              </div>
                            </div>
                          </div>
                          <div class="col-md-8">
                                ...
                                <div class="form-row">
                                  <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control mb-1" name="nama_pasien" id="nama_pasien"
                                      value="{{isset($poli)? $poli->pasien->nama_pasien : ''}}" readonly="">
                                  </div>
                                </div>
                                <div class="form-row">
                                  <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control mb-1" name="tanggal_lahir" id="tanggal_lahir"
                                      value="{{isset($poli)? $poli->pasien->tanggal_lahir : ''}}" readonly="">
                                  </div>
                                </div>
                                ...
                                <div class="form-row">
                                  <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control mb-1" name="status_pasien" id="status_pasien"
                                      value="{{isset($poli)? $poli->pendaftaran->status_pasien : ''}}" readonly="">
                                  </div>
                                </div>
                                <div class="form-row">
                                  <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control mb-1" name="no_bpjs" id="no_bpjs"
                                      value="{{isset($poli)? $poli->pasien->no_bpjs : ''}}" readonly="">
                                  </div>
                                </div>
                                  ...
                                  <div class="form-row">
                                    <div class="form-group col-md-4">
                                      ...
                                      <div class="input-group">
                                        <input type="text" class="form-control" name="keywoard" id="keywoard" value="{{ isset($poli->kd_diagnosa)? $poli->kd_diagnosa : '' }}"
                                          placeholder="masukan kode ....">
                                        <div class="input-group-prepend">
                                          <a class="btn btn-outline-success" id="searchDiagnosa" style="border-radius:0 3px 3px 0;">
                                    ...
                                    <div class="form-group col-md my-auto pt-2">
                                      <select name="diagnosa" class="custom-select" id="diagnosa">
                                  ...
                                  <div class="form-row">
                                    <div class="form-group col-md-6">
                                      ...
                                      <select name="kesadaran" class="custom-select" id="kesadaran">
                                        ...
                                        <option value="01" {{ ($poli->code_sadar == '01')? 'selected' : '' }}>Compos Mentis</option>
                                        <option value="02" {{ ($poli->code_sadar == '02')? 'selected' : '' }}>Somolence</option>
                                        <option value="03" {{ ($poli->code_sadar == '03')? 'selected' : '' }}>Sopor</option>
                                        <option value="04" {{ ($poli->code_sadar == '04')? 'selected' : '' }}>Coma</option>
                                      </select>
                                    </div>
                                  </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control mb-1" name="sistole" id="sistole" value="{{ isset($poli->sistole)? $poli->sistole : '' }}">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label class="form-label">Diastole <span>*</span></label>
                                        <input type="text" class="form-control mb-1" name="diastole" id="diastole" value="{{ isset($poli->diastole)? $poli->diastole : '' }}">
                                    </div>
                                </div>
                                <div class="form-row">
                                  <div class="form-group col-md-6">
                                    <label class="form-label">Tingkat Pernapasan <span>*</span></label>
                                    <input type="text" class="form-control mb-1" name="resp" id="resp" value="{{ isset($poli->resprate)? $poli->resprate : '' }}">
                                  </div>
                                  <div class="form-group col-md-6">
                                    <label class="form-label">Tekanan Nadi<span>*</span></label>
                                    <input type="text" class="form-control mb-1" name="heart" id="heart" value="{{ isset($poli->heart_rate)? $poli->heart_rate : '' }}">
                                  </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                      <label class="form-label">Berat Badan <span>*</span></label>
                                      <input type="text" class="form-control mb-1" name="berat" id="berat" value="{{ isset($poli->berat_badan)? $poli->berat_badan : '' }}">
                                    </div>
                                    <div class="form-group col-md-6">
                                      <label class="form-label">Tinggi Badan <span>*</span></label>
                                      <input type="text" class="form-control mb-1" name="tinggi" id="tinggi" value="{{ isset($poli->tinggi_badan)? $poli->tinggi_badan : '' }}">
                                    </div>
                                  </div>
                                <div class="form-row">
                                  <div class="form-group col-md-6">
                                    ...
                                    <select name="status_pulang" class="custom-select" id="status_pulang" onchange="rujukform()">
                                      ...
                                      <option value="1" {{ ($poli->status_pulang == '1')? 'selected' : '' }}>Meninggal</option>
                                      <option value="3" {{ ($poli->status_pulang == '3')? 'selected' : '' }}>Rawat Jalan</option>
                                      <option value="4" {{ ($poli->status_pulang == '4')? 'selected' : '' }}>Rujuk</option>
                                    </select>
                                  </div>
                                  <div class="form-group col-md-6">
                                    <label class="form-label">Tanggal Pulang <span>*</span></label>
                                    <input type="date" class="form-control mb-1" name="tglpulang" id="tglpulang" value="{{ isset($poli->tgl_daftar)? $poli->tgl_daftar : '' }}">
                                  </div>
                                </div>
                                ...
                                <div id="form_rujukan">
                                  <div class="form-row">
                                    <div class="form-group col-md-6" id="spesialisshowselect">
                                      <input type="radio" name="kasus" id="spesialis_select" {{ isset($poli->rujuk_lanjut->spesialis)? 'checked' : '' }}>
                                      <label for="spesialis">Spesialis <span>*</span></label>
                                    </div>
                                    <div class="form-group col-md-6" id="khususshowselect">
                                      <input type="radio" name="kasus" id="khusus_select" {{ isset($poli->rujuk_lanjut->kd_khusus)? 'checked' : '' }}>
                            ...
                            <div class="form-row" id="catatanshow">
                                <div class="form-group col-md-12">
                                  ...
                                  <textarea class="form-control mb-1" rows="5" name="note" id="note"></textarea>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-12">
...
<script type="text/javascript">
    var tamp_nokunjungan = '0';
      $(document).ready(function(){
        ...
        var statuspulang = $('select[name=status_pulang] option').filter(':selected').val()
        ...
        if($('#spesialis_select').is(':checked')){
            var spesialis = "{{ $poli->rujuk_lanjut->spesialis }}";
            $('#khususshow').hide();
            $('#spesialisshow').show();
            $('#khusus').val('');
            $('#subkhusus').val('');
            ...
            $.ajax({
              ...
              success: function(data){
                ...
                if (data.success == true) {
                    console.log(this.tamp_nokunjungan);
                    Swal.fire('Yes',data.message,'info');
                    // if(this.tamp_nokunjungan != '0'){
                    //     window.location.href = "{{route('report.cetakRujukan',[null])}}/"+this.tamp_nokunjungan;
                    // }else{
