        ...
        <div class="col-lg-12">
            <div class="ibox ">
                ...
                <form class="form-horizontal" id="submitData">
                    ...
                    <input type="hidden" name="enc_id" id="enc_id" value="{{isset($kunjungan)? $enc_id : ''}}">
                              ...
                              <div class="form-row">
                                <div class="form-group col-md-12">
                                  ...
                                  <select name="kdDokter" id="kdDokter" style="width:100%">
                                      <option value="{{ isset($kunjungan->pendaftaran->id_dokter)? $kunjungan->pendaftaran->id_dokter: '' }}" {{ isset($kunjungan->pendaftaran->id_dokter)? 'selected': '' }}>{{ isset($kunjungan->pendaftaran->id_dokter)? $kunjungan->pendaftaran->nama_penanggung_jawab: 'Pilih Tenaga Medis' }}</option>
                                  </select>
                              ...
                              <div class="form-row">
                                <div class="form-group col-md-12">
                                  ...
                                  <input type="text" class="form-control mb-1" name="nama_poli" id="nama_poli" readonly=""
                                    value="{{$kunjungan->pendaftaran->poli->nama_poli}}">
                                </div>
                              </div>
                            </div>
                          </div>
                          <div class="col-md-8">
                                ...
                                <div class="form-row">
                                  <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control mb-1" name="nama_pasien" id="nama_pasien"
                                      value="{{isset($kunjungan)? $kunjungan->pasien->nama_pasien : ''}}" readonly="">
                                  </div>
                                </div>
                                <div class="form-row">
                                  <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control mb-1" name="tanggal_lahir" id="tanggal_lahir"
                                      value="{{isset($kunjungan)? $kunjungan->pasien->tanggal_lahir : ''}}" readonly="">
                                  </div>
                                </div>
                                ...
                                <div class="form-row">
                                  <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control mb-1" name="status_pasien" id="status_pasien"
                                      value="{{isset($kunjungan)? $kunjungan->pendaftaran->status_pasien : ''}}" readonly="">
                                  </div>
                                </div>
                                <div class="form-row">
                                  <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control mb-1" name="no_bpjs" id="no_bpjs"
                                      value="{{isset($kunjungan)? $kunjungan->pendaftaran->no_bpjs : ''}}" readonly="">
                                  </div>
                                </div>
                                  ...
                                  <div class="form-row">
                                    <div class="form-group col-md-6">
                                      ...
                                      <select name="kesadaran" class="custom-select" id="kesadaran">
                                        ...
                                        <option value="01" {{ ($kunjungan->code_sadar == '01')? 'selected' : '' }}>Compos Mentis</option>
                                        <option value="02" {{ ($kunjungan->code_sadar == '02')? 'selected' : '' }}>Somolence</option>
                                        <option value="03" {{ ($kunjungan->code_sadar == '03')? 'selected' : '' }}>Sopor</option>
                                        <option value="04" {{ ($kunjungan->code_sadar == '04')? 'selected' : '' }}>Coma</option>
                                      </select>
                                    </div>
                                  </div>
                                <div class="form-row">
                                ...
                                <div class="form-row">
                                  <div class="form-group col-md-6">
                                    ...
                                    <select name="status_pulang" class="custom-select" id="status_pulang" onchange="rujukform()">
                                      ...
                                      <option value="1" {{ ($kunjungan->status_pulang == 1)? 'selected' : '' }}>Meninggal</option>
                                      <option value="3" {{ ($kunjungan->status_pulang == 3)? 'selected' : '' }}>Rawat Jalan</option>
                                      <option value="4" {{ ($kunjungan->status_pulang == 4)? 'selected' : '' }}>Rujuk</option>
                                    </select>
                                  </div>
                                  <div class="form-group col-md-6">
                                    <label class="form-label">Tanggal Pulang <span>*</span></label>
                                    <input type="date" class="form-control mb-1" name="tglpulang" id="tglpulang" value="{{ isset($kunjungan->tgl_pulang)? $kunjungan->tgl_pulang : '' }}">
                                  </div>
                                </div>
                                ...
                                <div id="form_rujukan" >
                                  ...
                                  <div class="form-row" id="terapishow">
                                    <div class="form-group col-md-12">
                                      ...
                                      <input type="text" class="form-control mb-1" name="terapi" id="terapi" value="{{ isset($kunjungan->terapi)? $kunjungan->terapi : '' }}">
                                    </div>
                                  </div>
                                </div>
                                {{-- <div class="form-row">
                                ...
                                <div id="form_rujukan_detail">
                                  ...
                                  <div class="form-row" id="tglrujukshow">
                                    <div class="form-group col-md-8">
                                      ...
                                      <input type="date" class="form-control mb-1" name="tglrujuk" id="tglrujuk" value="{{ isset($kunjungan->rujuk_lanjut->tgl_est_rujuk)? date('Y-m-d', strtotime($kunjungan->rujuk_lanjut->tgl_est_rujuk)) : date('Y-m-d') }}">
                                    </div>
                                  ...
                                  <div class="form-row">
                                    <div class="form-group col-md-6">
                                      <select name="tacc" class="custom-select" id="taccselect" onchange="taccform()">
                                        ...
                                        <option value="-1" selected>Tanpa TACC</option>
                            ...
                            <div class="form-row" id="catatanshow">
                                <div class="form-group col-md-12">
                                  ...
                                  <textarea class="form-control mb-1" rows="5" name="catatan" id="catatan">{{ isset($kunjungan->catatan)? $kunjungan->catatan : '' }}</textarea>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                  ...
                                  <select id="penunjang" name="penunjang" class="select2 form-control mb-1"
                                    ...
                                    <option value="Y" {{ (isset($kunjungan->pendaftaran->pelayanan_poli) && $kunjungan->pendaftaran->pelayanan_poli->penunjang == 'Y')? 'selected' : '' }}>Ya</option>
                                    <option value="T" {{ (isset($kunjungan->pendaftaran->pelayanan_poli) && $kunjungan->pendaftaran->pelayanan_poli->penunjang == 'T')? 'selected' : '' }}>Tidak</option>
...
var diag1 = "{{ $kunjungan->kd_diagnosa1 }}";
var diag2 = "{{ $kunjungan->kd_diagnosa2 }}";
var diag3 = "{{ $kunjungan->kd_diagnosa3 }}";
if(diag1 == ""){
    $('#diagnosa1').select2({
...
$('#diagnosa3').click(function(){
    ...
    var tamp_nokunjungan = '0';
      $(document).ready(function(){
        ...
        @if($kunjungan->status_pulang == "4")
            @if(isset($kunjungan->rujuk_lanjut) && $kunjungan->rujuk_lanjut->spesialis != null)
                var value_spesialis = "{{ $kunjungan->rujuk_lanjut->spesialis }}";
                @if($kunjungan->rujuk_lanjut->kd_sarana != null)
                    var value_sarana = "{{ $kunjungan->rujuk_lanjut->kd_sarana }}";
                @else
                    var value_sarana = 'null';
                @endif
                console.log(value_sarana);
                searchrujuk();
                spesialis(value_spesialis, value_sarana);
                @if($kunjungan->rujuk_lanjut->subspesialis != null)
                    var value = "{{ $kunjungan->rujuk_lanjut->subspesialis }}";
                    subspesialis(value_spesialis, value);
                    // console.log(value);
                @endif
            @endif
        @endif
    ...
    //   }
      ...
      function getdokter(){
        //   var id_dokter = $('#kdDokter').val();
          var dokterr = "{{ $kunjungan->kd_dokter }}";
          console.log(dokterr);
        $.ajax({
          type: 'POST',
    ...
    function spesialis(value, value_sarana){
        $('#khususshow').hide();
        $('#spesialisshow').show();
        $('#khusus').val('');
        $('#subkhusus').val('');
        $('#spesialis_select').attr('checked', true);
        var select;
        var select_sarana;
        // getdokter()
        $.ajax({
            ...
            if(response.datas.metaData.message != "OK"){
                ...
                for(var i = 0 ; i < spesialis.length ; i++){
                    if(spesialis[i].kdSpesialis == value){
                        select = 'selected';
                    }else{
                        select = '';
                    }
                $('#spesialis').append('<option value="'+spesialis[i].kdSpesialis+'" '+select+'>' + spesialis[i].nmSpesialis + '</option>');
                }
            }
            },
            complete: function(){
        ...
        $.ajax({
            ...
            if(response.datas.metaData.message != "OK"){
                ...
                for(var i = 0 ; i < sarana.length ; i++){
                    if(sarana[i].kdSarana == value_sarana){
                        select_sarana = 'selected';
                    }else{
                        select_sarana = '';
                    }
                $('#sarana').append('<option value="'+sarana[i].kdSarana+'" '+select_sarana+'>' + sarana[i].nmSarana + '</option>');
                }
            }
            },
            complete: function(){
    ...
    function subspesialis(id_spesialis, value){
        ...
        $.ajax({
            ...
            if(response.datas.metaData.message != "OK"){
                ...
                for(var i = 0 ; i < spesialis.length ; i++){
                    if(spesialis[i].kdSubSpesialis == value){
                        select = 'selected';
                    }else{
                        select = '';
                    }
                    $('#subspesialis').append('<option value="'+spesialis[i].kdSubSpesialis+'" '+select+'>' + spesialis[i].nmSubSpesialis + '</option>');
                }
            }else{
                Swal.fire('Error','Maaf Server Sedang Bermasalah','info');
            }
    ...
    function searchrujuk(){
        ...
        var nokartu = $('#no_bpjs').val();
        @if($kunjungan->no_kartu != '-')
            nokartu = '{{ $kunjungan->no_kartu }}';
        @endif
        var spesialis = $('#spesialis').val()
        @if(isset($kunjungan->rujuk_lanjut) && $kunjungan->rujuk_lanjut->spesialis != null)
            spesialis = '{{ $kunjungan->rujuk_lanjut->spesialis }}';
        @endif
        var kdsubspesialis = $('#subspesialis').val();
        @if(isset($kunjungan->rujuk_lanjut) && $kunjungan->rujuk_lanjut->subspesialis != null)
            kdsubspesialis = '{{ $kunjungan->rujuk_lanjut->subspesialis }}';
        @endif
        var kdsarana = $('#sarana').val();
        @if(isset($kunjungan->rujuk_lanjut) && $kunjungan->rujuk_lanjut->kd_sarana != null)
            kdsarana = '{{ $kunjungan->rujuk_lanjut->kd_sarana }}';
        @endif
        var kdkhusus = $('#khusus').val();
        @if(isset($kunjungan->rujuk_lanjut) && $kunjungan->rujuk_lanjut->kd_khusus != null)
            kdkhusus = '{{ $kunjungan->rujuk_lanjut->kd_sarana }}';
        @endif
        var kdsubkhusus = $('#subkhusus').val();
        @if(isset($kunjungan->rujuk_lanjut) && $kunjungan->rujuk_lanjut->kd_sarana != null)
            kdsubkhusus = '{{ $kunjungan->rujuk_lanjut->kd_sarana }}';
        @endif
        var date = $('#tglrujuk').val();
        var tglrujuk = date.split("-").reverse().join("-");
        @if(isset($kunjungan->rujuk_lanjut) && $kunjungan->rujuk_lanjut->tgl_est_rujuk != null)
            tglrujuk = "{{ date('d-m-Y', strtotime($kunjungan->rujuk_lanjut->tgl_est_rujuk))  }}";
        @endif
            ...
            success: function(response){
                ...
                if(response.datas){
                    ...
                    for (let index = 0; index < error.length; index++) {
                        ...
                        @if(isset($kunjungan->rujuk_lanjut))
                            var kdprovider = '{{ $kunjungan->rujuk_lanjut->kd_provider }}';
                        @endif
                    for(var i=0;i<table.length;i++){
                        if(table[i].kdppk == kdprovider){
                            select = 'checked';
                        }else{
                            select = '';
                        }
                    var datatable = '<tbody>' +
                                        ...
                                        '<td><input type="radio" name="provider" value="'+table[i].kdppk+'" id="'+table[i].kdppk+'" '+select+'></td>'+
                                        '</tr>' +
                                    '</tbody>'
