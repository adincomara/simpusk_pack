...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="row">
        ...
        <div class="ibox ">
            ...
            <table class="table table-striped table-bordered table-hover dataTables-example coba" id="table_pengeluaran_obat" >
            <thead>
   ...
   var tabledata,table_index;
      $(document).ready(function(){
        $.ajaxSetup({
          ...
          "select" : true,
          "ajax":{
                   "url": "{{ route("pengeluaran_obat.getdata") }}",
                   "dataType": "json",
                   "type": "POST",
                   data: function ( d ) {
                     d._token= "{{csrf_token()}}";
            ...
            $.ajax({
                ...
                success:function (data) {
                    for(i=0;i<data.jumlah;i++){
                        toastr.success("Halo, ada pasien "+data.pendaftaran[i].pasien.nama_pasien+" yang perlu di proses resep, silahkan klik tombol proses resep obat")
                        audio.play();
                    }
                },
                complete: function(){
