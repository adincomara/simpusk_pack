            ...
            <div class="ibox-title">
                ...
                <div class="ibox-tools">
                    @can('supplier.tambah')
                        ...
                        <a href="{{ route('supplier.excel') }}" target="_blank"><button class="btn btn-warning"><i class="fa fa-file-excel"></i> Download</button></a>
                        <a href="{{ route('supplier.cetak') }}"  target="_blank"><button class="btn btn-success"><i class="fa fa-file-pdf"></i> Cetak PDF</button></a>
                        <a href="{{ route('supplier.tambah') }}"><button class="btn btn-primary"><i class="fa fa-plus"></i> Supplier </button></a>
                    @endcan
