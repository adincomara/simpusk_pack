...
@section('judultable', 'Data Obat')
@section('menu1', 'Master')
@section('menu2', 'Data Obat')
@section('table')
        ...
        <div class="ibox ">
            <div class="ibox-title">
                ...
                <div class="ibox-tools">
                    @can('obat.tambah')
                        <a href="{{ route('obat.tambah') }}"><button class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Obat </button></a>
                    @endcan
            ...
            <table class="table table-striped table-bordered table-hover dataTables-example coba" id="table_obat" >
            <thead>
       ...
       function deleteData(e,enc_id){
          ...
          if (result.value) {
            $.ajaxSetup({
             ...
             $.ajax({
              type: 'DELETE',
              url: '{{route("obat.hapus",[null])}}/' + enc_id,
