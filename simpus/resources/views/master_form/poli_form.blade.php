                    ...
                    <form id="submitData">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control mb-1" name="nama_poli" id="nama_poli"
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control mb-1" name="kdpoli" id="kdpoli"
                                    value="{{isset($poli)? $poli->kdpoli : ''}}">
                            </div>
                        </div>

                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <label class="form-label">Kode Antrian Poli (Untuk Huruf Awal Antrean)
                                    <span>*</span></label>
                                <input type="text" class="form-control mb-1" name="kode_poli" id="kode_poli"
                                    value="{{isset($poli)? $poli->kode_poli : ''}}">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <select name="status" class="form-control" id="">
                                    ...
                                    <option value="0" {{ ($selectedstatus=='0' )? 'selected' : '' }}>Tidak Aktif
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <div class="d-flex justify-content-between mb-2">
                                    <label class="form-label">Dokter Penanggung Jawab
                                        <span>*</span>
                                    </label>
                                    <a href="#!" class="btn btn-primary ml-5" id="tambah_dokter"> <i
                                ...
                                <table id="dokter_penanggung" class="my-2" width="100%">
        ...
        <script>
            ...
            $('#tambah_dokter').on('click', function(){
                let html = '<tr id="dokter_'+index+'">'
                                +'<td style="width:95%"><select name="dokter[]" class="form-control dokter"></select></td>'
                                +'<td style="width:5%"><a href="#!" class="btn btn-danger" id="delete_dokter" onclick="delete_dokter('+index+')"><i class="fa fa-trash" aria-hidden="true"></i> Hapus</a></td>'
                            +'</tr>';
            ...
            @if(isset($poli) && count($dokter) > 1)
                @foreach ($dokter as $key => $dkr)
                    ...
                    html = '<tr id="dokter_'+index+'">'
                                +'<td style="width:95%"><select name="dokter[]" class="form-control dokter">'
