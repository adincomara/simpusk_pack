...
@section('judultable', 'Data Pemeriksaan Laboratorium')
    ...
    <div class="row">
        ...
        <div class="ibox ">
            <div class="ibox-title">
                <h3>Data Pemeriksaan Laboratorium</h3>
                <div class="ibox-tools">
                    @can('laboratorium.tambah')
                        <a href="{{ route('laboratorium.tambah') }}"><button class="btn btn-primary">Tambah Pemeriksaan Laboratorium</button></a>
                    @endcan
   ...
   var tabledata,table_index;
      $(document).ready(function(){
        $.ajaxSetup({
          ...
          "select" : true,
          "ajax":{
                   "url": "{{ route("laboratorium.getdatamaster") }}",
                   "dataType": "json",
                   "type": "POST",
                   data: function ( d ) {
                     d._token= "{{csrf_token()}}";
