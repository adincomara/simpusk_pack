...
@section('judultable', 'Data Spesialis')
        ...
        <div class="ibox ">
            <div class="ibox-title">
                ...
                <div class="ibox-tools">
                    <a href="{{ route('spesialis.tambah') }}"><button class="btn btn-primary">Tambah Spesialis</button></a>
                    {{ csrf_field() }}
            ...
            <table class="table table-striped table-bordered table-hover dataTables-example coba" id="table_spesialis" >
            <thead>
   ...
   var tabledata,table_index;
      $(document).ready(function(){
        $.ajaxSetup({
          ...
          table= $('#table_spesialis').DataTable({
          "processing": true,
          "serverSide": true,
          "stateSave"  : true,
          "deferRender": true,
       ...
       function deleteData(e,enc_id){
          ...
          if (result.value) {
            $.ajaxSetup({
             ...
             $.ajax({
              type: 'DELETE',
              url: '{{route("spesialis.hapus",[null])}}/' + enc_id,
