...
@section('judultable', 'Data Bidang')
        ...
        <div class="ibox ">
            <div class="ibox-title">
                ...
                <div class="ibox-tools">
                    @can('bidang.tambah')
                        <a href="{{ route('bidang.tambah') }}"><button class="btn btn-primary">Tambah Bidang</button></a>
                    @endcan
            ...
            <table class="table table-striped table-bordered table-hover dataTables-example coba" id="table_bidang" >
            <thead>
       ...
       function deleteData(e,enc_id){
          ...
          if (result.value) {
            $.ajaxSetup({
             ...
             $.ajax({
              type: 'DELETE',
              url: '{{route("bidang.hapus",[null])}}/' + enc_id,
