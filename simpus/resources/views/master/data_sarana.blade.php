...
@section('judultable', 'Data Sarana')
        ...
        <div class="ibox ">
            <div class="ibox-title">
                ...
                <div class="ibox-tools">
                    <a href="{{ route('sarana.tambah') }}"><button class="btn btn-primary">Tambah Sarana</button></a>
                    {{ csrf_field() }}
            ...
            <table class="table table-striped table-bordered table-hover dataTables-example coba" id="table_sarana" >
            <thead>
       ...
       function deleteData(e,enc_id){
          ...
          if (result.value) {
            $.ajaxSetup({
             ...
             $.ajax({
              type: 'DELETE',
              url: '{{route("sarana.hapus",[null])}}/' + enc_id,
