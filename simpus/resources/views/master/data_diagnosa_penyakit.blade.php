...
@section('title', 'Data Diagnosa Penyakit')
@section('judultable', 'Data Diagnosa Penyakit')
    ...
    <div class="row">
        ...
        <div class="ibox ">
            <div class="ibox-title">
                <h3>Data Diagnosa Penyakit</h3>
                <div class="ibox-tools">
                    @can('diagnosa_penyakit.tambah')
                        <a href="{{ route('diagnosa_penyakit.tambah') }}"><button class="btn btn-primary">Tambah Diagnosa Penyakit</button></a>
                    @endcan
            ...
            <table class="table table-striped table-bordered table-hover dataTables-example coba" id="table_diagnosa_penyakit" >
            <thead>
   ...
   var tabledata,table_index;
      $(document).ready(function(){
        $.ajaxSetup({
          ...
          table= $('#table_diagnosa_penyakit').DataTable({
          "processing": true,
          "serverSide": true,
          "stateSave"  : true,
          "deferRender": true,
          ...
          "select" : true,
          "ajax":{
                   "url": "{{ route("diagnosa_penyakit.getdata") }}",
                   "dataType": "json",
                   "type": "POST",
                   data: function ( d ) {
                     d._token= "{{csrf_token()}}";
       ...
       function deleteData(e,enc_id){
          @cannot('diagnosa_penyakit.hapus')
          ...
          if (result.value) {
            $.ajaxSetup({
             ...
             $.ajax({
              type: 'DELETE',
              url: '{{route("diagnosa_penyakit.hapus",[null])}}/' + enc_id,
