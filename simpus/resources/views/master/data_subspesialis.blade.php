...
@section('title', 'Data SubSpesialis')
@section('judultable', 'Data SubSpesialis')
    ...
    <div class="row">
        ...
        <div class="ibox ">
            <div class="ibox-title">
                <h3>Data SubSpesialis</h3>
                <div class="ibox-tools">
                    <a href="{{ route('subspesialis.tambah') }}"><button class="btn btn-primary">Tambah SubSpesialis</button></a>
                    {{ csrf_field() }}
            ...
            <table class="table table-striped table-bordered table-hover dataTables-example coba" id="table_subspesialis" >
            <thead>
   ...
   var tabledata,table_index;
      $(document).ready(function(){
        $.ajaxSetup({
          ...
          table= $('#table_subspesialis').DataTable({
          "processing": true,
          "serverSide": true,
          "stateSave"  : true,
          "deferRender": true,
          ...
          "select" : true,
          "ajax":{
                   "url": "{{ route("subspesialis.getdata") }}",
                   "dataType": "json",
                   "type": "POST",
                   data: function ( d ) {
                     d._token= "{{csrf_token()}}";
       ...
       function deleteData(e,enc_id){
          ...
          if (result.value) {
            $.ajaxSetup({
             ...
             $.ajax({
              type: 'DELETE',
              url: '{{route("subspesialis.hapus",[null])}}/' + enc_id,
