...
@section('title', 'Data Kesadaran')
@section('judultable', 'Data Kesadaran')
    ...
    <div class="row">
        ...
        <div class="ibox ">
            <div class="ibox-title">
                <h3>Data Kesadaran</h3>
                <div class="ibox-tools">
                    <a href="{{ route('kesadaran.tambah') }}"><button class="btn btn-primary">Tambah Kesadaran</button></a>
                    {{ csrf_field() }}
            ...
            <table class="table table-striped table-bordered table-hover dataTables-example coba" id="table_kesadaran" >
            <thead>
   ...
   var tabledata,table_index;
      $(document).ready(function(){
        $.ajaxSetup({
          ...
          table= $('#table_kesadaran').DataTable({
          "processing": true,
          "serverSide": true,
          "stateSave"  : true,
          "deferRender": true,
       ...
       function deleteData(e,enc_id){
          ...
          if (result.value) {
            $.ajaxSetup({
             ...
             $.ajax({
              type: 'DELETE',
              url: '{{route("kesadaran.hapus",[null])}}/' + enc_id,
