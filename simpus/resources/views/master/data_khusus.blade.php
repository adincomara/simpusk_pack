...
@section('judultable', 'Data Khusus')
        ...
        <div class="ibox ">
            <div class="ibox-title">
                ...
                <div class="ibox-tools">
                    <a href="{{ route('khusus.tambah') }}"><button class="btn btn-primary">Tambah Khusus</button></a>
                    {{ csrf_field() }}
            ...
            <table class="table table-striped table-bordered table-hover dataTables-example coba" id="table_khusus" >
            <thead>
       ...
       function deleteData(e,enc_id){
          ...
          if (result.value) {
            $.ajaxSetup({
             ...
             $.ajax({
              type: 'DELETE',
              url: '{{route("khusus.hapus",[null])}}/' + enc_id,
