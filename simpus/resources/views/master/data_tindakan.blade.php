...
@section('judultable', 'Data Tindakan')
        ...
        <div class="ibox ">
            <div class="ibox-title">
                ...
                <div class="ibox-tools">
                    @can('tindakan.tambah')
                        <a href="{{ route('tindakan.tambah') }}"><button class="btn btn-primary">Tambah Tindakan</button></a>
                    @endcan
            ...
            <table class="table table-striped table-bordered table-hover dataTables-example coba" id="table_tindakan" >
            <thead>
       ...
       function deleteData(e,enc_id){
          ...
          if (result.value) {
            $.ajaxSetup({
             ...
             $.ajax({
              type: 'DELETE',
              url: '{{route("tindakan.hapus",[null])}}/' + enc_id,
