...
@section('judultable', 'Data Penyakit')
        ...
        <div class="ibox ">
            <div class="ibox-title">
                ...
                <div class="ibox-tools">
                    @can('penyakit.tambah')
                        <a href="{{ route('penyakit.tambah') }}"><button class="btn btn-primary">Tambah Penyakit</button></a>
                    @endcan
            ...
            <table class="table table-striped table-bordered table-hover dataTables-example coba" id="table_penyakit" >
            <thead>
   ...
   var tabledata,table_index;
      $(document).ready(function(){
        $.ajaxSetup({
          ...
          table= $('#table_penyakit').DataTable({
          "processing": true,
          "serverSide": true,
          "stateSave"  : true,
          "deferRender": true,
       ...
       function deleteData(e,enc_id){
          ...
          if (result.value) {
            $.ajaxSetup({
             ...
             $.ajax({
              type: 'DELETE',
              url: '{{route("penyakit.hapus",[null])}}/' + enc_id,
