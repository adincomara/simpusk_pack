        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li
                        ...
                        <ul class="nav nav-second-level collapse">
                            ...
                            <li class="{{ Route::currentRouteName() === 'kasus_indera.index' ? 'active' : '' }}"><a
                                    href="{{route('kasus_indera.index')}}">Kasus Gangguan Penglihatan & Pendengaran</a>
                            </li>
                    ...
                    <li
                        ...
                        <ul class="nav nav-second-level collapse">
                            <li class="{{ Route::currentRouteName() === 'dd_fr_ptm_keswa.index' ? 'active' : '' }}"><a
                                    href="{{route('dd_fr_ptm_keswa.index')}}">Deteksi Dini Faktor Risiko PTM & KESWA</a>
                            </li>
                            ...
                            <li
                                ...
                                <a href=" #"><span class="nav-label">IVA SADANIS</span><span
                                        class="fa arrow"></span></a>
                                <ul class="nav nav-third-level">
                                    ...
                                    <li class="{{ Route::currentRouteName() === 'form_f.index' ? 'active' : '' }}"><a
                                            href="{{route('form_f.index')}}">Form F</a></li>
                                </ul>
                            </li>
                    ...
                    <li
                        class="{{ Route::currentRouteName() === 'profil_sdm.index'|| Route::currentRouteName() === 'profil_uspro.index' || Route::currentRouteName() === 'profil_ht.index' || Route::currentRouteName() === 'profil_dm.index' || Route::currentRouteName() === 'profil_iva.index'  || Route::currentRouteName() === 'profil_sdm.index' || Route::currentRouteName() === 'profil_odgj.index' ? 'active' : '' }}">
                        <a href=" #"><i class="fa fa-bars"></i> <span class="nav-label">Profil</span><span
                                class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse">
                            <li class="{{ Route::currentRouteName() === 'profil_uspro.index' ? 'active' : '' }}"><a
                                    href="{{route('profil_uspro.index')}}">Usia Produktif</a></li>
                            <li class="{{ Route::currentRouteName() === 'profil_ht.index' ? 'active' : '' }}"><a
                                    href="{{route('profil_ht.index')}}">Hipertensi</a></li>
                            <li class="{{ Route::currentRouteName() === 'profil_dm.index' ? 'active' : '' }}"><a
                                    href="{{route('profil_dm.index')}}">Diabetes Mellitus</a></li>
                            <li class="{{ Route::currentRouteName() === 'profil_iva.index' ? 'active' : '' }}"><a
                                    href="{{route('profil_iva.index')}}">IVA-SADANIS</a></li>
                            <li class="{{ Route::currentRouteName() === 'profil_odgj.index' ? 'active' : '' }}"><a
                                    href="{{route('profil_odgj.index')}}">ODGJ</a></li>
                    ...
                    <li
                        ...
                        <ul class="nav nav-second-level collapse">
                            ...
                            <li
                                class="{{ Route::currentRouteName() === 'analisa_kasus_ptm_usia.index' ? 'active' : '' }}">
                                <a href="{{route('analisa_kasus_ptm_usia.index')}}">Kasus PTM berdasrakan golongan
                                    umur</a>
                            </li>
                            <li
                            ...
                            <li class="{{ Route::currentRouteName() === 'analisa_kasus_jiwa.index' ? 'active' : '' }}">
                                <a href="{{route('analisa_kasus_jiwa.index')}}">Kasus Ganguan Jiwa</a>
                            </li>
                            <li
                                class="{{ Route::currentRouteName() === 'analisa_kasus_jiwa_usia.index' ? 'active' : '' }}">
                                <a href="{{route('analisa_kasus_jiwa_usia.index')}}">Kasus Ganguan Jiwa berdasrakan
                                    golongan
                                    umur</a>
                            </li>
                            <li
                                class="{{ Route::currentRouteName() === 'analisa_kasus_jiwa_jenis_kelamin.index' ? 'active' : '' }}">
                                <a href="{{route('analisa_kasus_jiwa_jenis_kelamin.index')}}">Kasus Ganguan Jiwa
                                    berdasarkan
                                    jenis
                                    kelamin</a>
                            </li>
                            ...
                            <li
                                class="{{ Route::currentRouteName() === 'analisa_hasil_charta.index' ? 'active' : '' }}">
                                <a href="{{route('analisa_hasil_charta.index')}}">Hasil Prediksi Charta PANDU</a>
                            </li>
                            <li
                                class="{{ Route::currentRouteName() === 'analisa_faktor_risiko.index' ? 'active' : '' }}">
                                <a href="{{route('analisa_faktor_risiko.index')}}">Faktor Risiko PTM</a>
                            </li>
                            <li class="{{ Route::currentRouteName() === 'analisa_temuan_iva.index' ? 'active' : '' }}">
                                <a href="{{route('analisa_temuan_iva.index')}}">Hasil Temuan Pemeriksaan IVA</a>
                            </li>
                            <li
                                class="{{ Route::currentRouteName() === 'analisa_temuan_sadanis.index' ? 'active' : '' }}">
                                <a href="{{route('analisa_temuan_sadanis.index')}}">Hasil Temuan Pemeriksaan SADANIS</a>
                            </li>
                            <li
                                class="{{ Route::currentRouteName() === 'analisa_temuan_ivakrio.index' ? 'active' : '' }}">
                                <a href="{{route('analisa_temuan_ivakrio.index')}}">Temuan IVA (+) dan Tindakan
                                    Kriotherapi</a>
                            </li>
                        </ul>
                    </li>
