            ...
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li class="{{  request()->routeIs('manage.beranda') ? 'active' : '' }}">
                        <a href="{{ route('home') }}"><i class="fa fa-home" style="font-size:16px"
                                aria-hidden="true"></i> <span class="nav-label">Beranda</span></a>
                    </li>
                    @can('master.index')
                    <li class="">
                        <a href="#"><i class="fa fa-database" style="font-size:16px"></i> <span
                                class="nav-label">Master</span>
                            <span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            @can('jabatan.index')
                            <li class=""><a href="{{ route('jabatan.index') }}">Data Jabatan</a></li>
                            @endcan
                            @can('bidang.index')
                            <li class=""><a href="{{ route('bidang.index') }}">Data Bidang</a></li>
                            @endcan
                            @can('pegawai.index')
                            <li class=""><a href="{{ route('pegawai.index') }}">Data Pegawai</a></li>
                            @endcan
                            @can('kk.index')
                            ...
                            @endcan
                            @can('pasien.index')
                            <li class=""><a href="{{ route('pasien.index') }}">Data Pasien</a></li>
                            @endcan
                            @can('poli.index')
                            <li class=""><a href="{{ route('poli.index') }}">Data Poli </a></li>
                            @endcan
                            @can('jenisoperasi.index')
                            <li class=""><a href="{{ route('jenisoperasi.index') }}">Data Jenis Operasi</a></li>
                            @endcan
                            @can('penyakit.index')
                            <li class=""><a href="{{ route('penyakit.index') }}">Data Penyakit</a></li>
                            @endcan
                            @can('tindakan.index')
                            <li class=""><a href="{{ route('tindakan.index') }}">Data Tindakan</a></li>
                            @endcan
                            @can('diagnosa_penyakit.index')
                            <li class=""><a href="{{ route('diagnosa_penyakit.index') }}">Data Diagnosis Penyakit</a>
                            </li>
                            @endcan
                            @can('laboratorium.index')
                            <li class=""><a href="{{ route('laboratorium.master') }}">Data Pemeriksaan Laboratorium</a>
                            </li>
                            @endcan
                        </ul>
                    </li>
...
=======
>>>>>>> 15218d9a29a8d1df451f07b1dbdc30e03e5a8b53
                    <li>
                        {{-- <a href="{{ route('antrian.index') }}"><i class="fa fa-ticket" style="font-size:16px"></i>
                            <span class="nav-label">Antrian</span></a> --}}
                        {{-- <ul class="nav nav-second-level">
                        </ul> --}}
                    </li>
                    @can('pelayanan.index')
                    <li class="">
                        ...
                        <ul class="nav nav-second-level">
                            @can('pendaftaran.index')
                            <li class=""><a href="{{ route('pendaftaran.index') }}"
                                    id="notif_pendaftaran">Pendaftaran</a></li>
                            @endcan
                            @can('pelayanan_poli.index')
                            <li class=""><a href="{{ route('pelayanan_poli.index') }}" id="notif_poli">Poli</a></li>
                            @endcan
                            @can('laboratorium.index')
                            <li class=""><a href="{{ route('laboratorium.index') }}" id="notif_lab">Laboratorium</a>
                            </li>
                            @endcan
                        </ul>
                    </li>
                    ...
                    @can('apotik.index')
                    <li class="">
                        <a href="#"><i class="fa fa-medkit" style="font-size:16px"></i> <span
                                class="nav-label">Apotik</span>
                            <span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            @can('supplier.index')
                            <li class=""><a href="{{ route('supplier.index') }}">Data Suplier</a></li>
                            @endcan
                            @can('obat.index')
                            <li class=""><a href="{{ route('obat.index') }}">Data Obat</a></li>
                            @endcan
                            @can('stok_obat.index')
                            <li class=""><a href="{{ route('stok_obat.index') }}">Data Stok Obat</a></li>
                            @endcan
                            @can('pengadaan_obat.index')
                            <li class=""><a href="{{ route('pengadaan_obat.index') }}">Pengadaan Obat</a></li>
                            @endcan
                            @can('pengeluaran_obat.index')
                            <li class=""><a href="{{ route('pengeluaran_obat.index') }}" id="notif_out_obat">Pengeluaran
                                    Obat</a></li>
                            @endcan
                        </ul>
                    </li>
                    ...
                    <li class="">
                        <a href="#"><i class="fa fa-sticky-note" style="font-size:16px"></i> <span
                                class="nav-label">Laporan</span>
                            <span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li class="">
                                <a href="{{route('report.penyakitterbesar')}}">Laporan 10 Besar Penyakit</a>
                            </li>
                            <li class="">
                                <a href="{{route('report.pasienDiagnosa')}}">Laporan Pasien Berdasarkan Diagnosa</a>
                            </li>
                            <li class="">
                                <a href="{{route('report.pasienTindakan')}}">Laporan Pasien Berdasarkan Tindakan</a>
                            </li>
                            <li class="">
                                <a href="{{route('report.tindakanpasien_index')}}">Laporan Tindakan Pasien</a>
                            </li>
                            <li class="">
                                <a href="{{route('tenagakesehatan.index')}}">Tenaga Puskesmas</a>
                            </li>
                            <li class=""><a href="{{route('jabatannakes.index')}}">Jabatan Nakes</a></li>
                            <li class=""><a href="{{route('report.pemberianobat.index')}}">Pemberian Obat</a></li>
                            <li class=""><a href="{{route('report.kunjunganpasien.index')}}">Kunjungan Pasien (Baru dan
                                    Lama)</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-ambulance" style="font-size:16px"></i> <span
                                class="nav-label">Integrasi
                                BPJS</span> <span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li class=""><a href="{{route('kunjungan.pasienBPJS')}}">Kunjungan Pasien</a></li>
                            <li class=""><a href="{{route('report.rujukanBPJS')}}">Rujukan Pasien BPJS (PCARE)</a></li>
                    ...
                    @can('pengguna.index')
                    <li class="">
                        <a href="#"><i class="fa fa-users" style="font-size:16px"></i> <span
                                class="nav-label">Pengguna</span>
                            <span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            @can('staff.index')
                            <li class=""><a href="{{ route('staff.index') }}">Staff</a></li>
                            @endcan
                        </ul>
                    </li>
                    @endcan
                    @can('company.index')
                    <li class="">
                        <a href="#"><i class="fa fa-cogs" style="font-size:16px"></i> <span
                                class="nav-label">Pengaturan</span>
                            <span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            @can('about.index')
                            <li class=""><a href="{{ route('about.index') }}">Tentang</a></li>
                            @endcan
                            @can('pcare.index')
                            <li class=""><a href="{{ route('pcare.index') }}">PCare</a></li>
                            @endcan
                    ...
                    @can('security.index')
                    <li class="">
                        <a href="#"><i class="fa fa-lock" style="font-size:16px"></i> <span
                                class="nav-label">Keamanan</span>
                            <span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            @can('permission.index')
                            <li class=""><a href="{{ route('permission.index') }}">Modul</a></li>
                            @endcan
                            @can('role.index')
                            <li class=""><a href="{{ route('role.index') }}">Akses</a></li>
                            @endcan
                        </ul>
                    </li>
                    @endcan
