...
@section('title', 'Hasil Prediksi Charta')
@section('judultable', 'Hasil Prediksi Charta')
{{-- @section('subjudul', '(Hasil Prediksi Charta)') --}}
@section('menu1', 'Analisa')
@section('menu2', 'Hasil Prediksi Charta')
@section('table_ptm')
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title b-r-xl">
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="ml-3">Grafik Hasil Prediksi Charta</h3>
                        </div>
        ...
        <script type="text/javascript">
            ...
            const data = {
                labels: ['Charta < 5%','Charta 5% - 10%','Charta 10% - 20%','Charta 20% - 30%','Charta > 30%'],datasets: [{
                    label: '',
                    data: [5,5,3,6,3,2],
                    backgroundColor: [
                        '#1ab32c',
            ...
            const config = {
                ...
                options: {
                    ...
                    title: {
                        display: true,
                        text: 'Grafik Analisa Hasil Prediksi Charta'
                    },
                    layout: {
                        padding: {
                            top: 32,
