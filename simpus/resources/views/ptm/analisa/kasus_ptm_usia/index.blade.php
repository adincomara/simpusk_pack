...
@section('title', 'Kasus PTM berdasarkan Golongan Umur')
@section('judultable', 'Kasus PTM berdasarkan Golongan Umur')
{{-- @section('subjudul', '(Kasus PTM berdasarkan Golongan Umur)') --}}
@section('menu1', 'Analisa')
@section('menu2', 'Kasus PTM berdasarkan Golongan Umur')
@section('table_ptm')
        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title b-r-xl">
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="ml-3">Grafik Kasus PTM berdasarkan Golongan Umur</h3>
                        </div>
        ...
        <script type="text/javascript">
            ...
            const data = {
                ...
                datasets: [
                    {
                        label: ' 0-14 ',
                        data: [12,5,1,5,3,6,3,2,4,1,2,4,6,3,2,4,5],
                    ...
                    {
                        label: ' 15-59 ',
                        data: [11,4,6,3,2,4,5,5,1,4,1,2,5,3,6,3,2],
                    ...
                    {
                        label: ' >=60 ',
                        data: [2,4,5,5,3,6,3,10,2,5,1,4,1,2,4,6,3,],
            ...
            const config = {
                ...
                options: {
                    ...
                    title: {
                        display: true,
                        text: 'Grafik Analisa Kasus PTM Berdasarkan Golongan Umur'
                    },
                    layout: {
                        padding: {
                            top: 32,
