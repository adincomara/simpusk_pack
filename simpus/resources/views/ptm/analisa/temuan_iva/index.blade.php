...
@section('title', 'Hasil Temuan Pemeriksaan IVA (IVA (+),Curiga Kanker,Kelainan Obsgyn lainnya)')
@section('judultable', 'Hasil Temuan Pemeriksaan IVA (IVA (+),Curiga Kanker,Kelainan Obsgyn lainnya)')
{{-- @section('subjudul', '(Hasil Temuan Pemeriksaan IVA (IVA (+),Curiga Kanker,Kelainan Obsgyn lainnya))') --}}
@section('menu1', 'Analisa')
@section('menu2', 'Hasil Temuan Pemeriksaan IVA (IVA (+),Curiga Kanker,Kelainan Obsgyn lainnya)')
@section('table_ptm')
        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title b-r-xl">
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="ml-3">Grafik Hasil Temuan Pemeriksaan IVA (IVA (+),Curiga Kanker,Kelainan Obsgyn
                                lainnya)</h3>
                        </div>
        ...
        <script type="text/javascript">
            ...
            const config = {
                ...
                options: {
                    ...
                    title: {
                        display: true,
                        text: 'Grafik Analisa Hasil Temuan Pemeriksaan IVA (IVA (+),Curiga Kanker,Kelainan Obsgyn lainnya)'
                    },
                    layout: {
                        padding: {
                            top: 32,
