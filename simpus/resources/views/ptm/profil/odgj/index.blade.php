...
@section('title', 'Pelayan Kesehatan Orang Dengan Gangguan Jiwa(ODGJ) Berat')
@section('judultable', 'Pelayan Kesehatan Orang Dengan Gangguan Jiwa(ODGJ) Berat')
{{-- @section('subjudul', '(Pelayan Kesehatan Orang Dengan Gangguan Jiwa(ODGJ) Berat)') --}}
@section('menu1', 'Profil')
@section('menu2', 'Pelayan Kesehatan Orang Dengan Gangguan Jiwa(ODGJ) Berat')
@section('table_ptm')
        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title b-r-xl">
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="ml-3">Pelayan Kesehatan Orang Dengan Gangguan Jiwa(ODGJ) Berat</h3>
                        </div>
                        ...
                        <table id="table1" class="table p-0 table-bordered text-center table-hover"
                            ...
                            <thead>
                                <tr class="text-center bg-primary">
                                    ...
                                    <th class="align-middle bg-primary" colspan="3">PELAYANAN KESEHATAN ODGJ BERAT</th>
                                    <th class="align-middle bg-primary" rowspan="3">Action</th>
                                </tr>
                                <tr class="text-center bg-primary">
                                    <th class="align-middle" rowspan="2">SASARAN ODGJ BERAT</th>
                                    <th class="align-middle bg-primary" colspan="2">MENDAPAT PELAYANAN KESEHATAN</th>
                                </tr>
                                <tr class="text-center bg-primary">
