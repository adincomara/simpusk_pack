...
@section('title', 'Bumil Mendapatkan Fe 1')
@section('judultable', 'Bumil Mendapatkan Fe 1')
@section('subjudul', '(Laporan Bumil Mendapatkan Fe 1)')
@section('menu1', 'Menu Lainnya')
@section('menu2', 'Bumil Mendapatkan Fe 1')
@section('table_kia')
<style>
    .text-datatable {
        width: 100px;
        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title b-r-xl">
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="ml-3">Daftar Bumil Mendapatkan Fe 1</h3>
                        </div>
