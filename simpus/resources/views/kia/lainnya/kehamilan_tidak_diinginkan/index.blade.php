...
@section('title', 'Kehamilan yang tidak diinginkan')
@section('judultable', 'Kehamilan yang tidak diinginkan')
@section('subjudul', '(Kehamilan yang tidak diinginkan)')
@section('menu1', 'Menu Lainnya')
@section('menu2', 'Kehamilan yang tidak diinginkan')
@section('table_kia')
<style>
    .text-datatable {
        width: 100px;
        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title b-r-xl">
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="ml-3">Daftar Kehamilan yang tidak diinginkan</h3>
                        </div>
