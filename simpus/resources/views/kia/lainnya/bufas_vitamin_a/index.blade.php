...
@section('title', 'Bufas Vitamin A')
@section('judultable', 'Bufas Vitamin A')
@section('subjudul', '(Ibu nifas mendapatkan vitamin A)')
@section('menu1', 'Menu Lainnya')
@section('menu2', 'Bufas Vitamin A')
@section('table_kia')
<style>
    .text-datatable {
        width: 100px;
        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title b-r-xl">
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="ml-3">Daftar Bufas Vitamin A</h3>
                        </div>
