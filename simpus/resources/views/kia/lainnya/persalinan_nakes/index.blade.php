...
@section('title', 'Persalinan Nakes')
@section('judultable', 'Persalinan Nakes')
@section('subjudul', '(Jumlah Persalinan di Nakes)')
@section('menu1', 'Menu Lainnya')
@section('menu2', 'Persalinan Nakes')
@section('table_kia')
<style>
    .text-datatable {
        width: 100px;
        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title b-r-xl">
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="ml-3">Daftar Persalinan Nakes</h3>
                        </div>
