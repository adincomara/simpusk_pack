...
@section('judultable', 'Kunjungan Nifas')
@section('subjudul', '(Kunjungan Nifas KF1 KF2 KF3 atau KB)')
@section('menu1', 'Menu Lainnya')
@section('menu2', 'Kunjungan Nifas')
@section('table_kia')
<style>
    .text-datatable {
        width: 100px;
        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title b-r-xl">
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="ml-3">Daftar Kunjungan Nifas</h3>
                        </div>
                            ...
                            <thead>
                                ...
                                <tr class="text-white">
                                    <?php
                                                                        for($i=1;$i<=12;$i++){
                                                                    ?>
                                    <th class="bg-primary" style="z-index: 90">KF1</th>
                                    <th class="bg-primary" style="z-index: 90">KF2</th>
                                    <th class="bg-primary">KF3</th>
                                    <th class="bg-primary">KB</th>
                                    <?php
                                                                        }
                                                                    ?>
                                </tr>
