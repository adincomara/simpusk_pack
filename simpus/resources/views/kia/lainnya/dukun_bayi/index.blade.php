...
@section('title', 'Dukun Bayi')
@section('judultable', 'Dukun Bayi')
@section('subjudul', '(Jumlah dukun bayi bermitra dan tidak bermitra)')
@section('menu1', 'Menu Lainnya')
@section('menu2', 'Dukun Bayi')
@section('table_kia')
<style>
    .text-datatable {
        width: 100px;
        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title b-r-xl">
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="ml-3">Daftar Dukun Bayi</h3>
                        </div>
                        ...
                        <table id="table1" class="table p-0 table-bordered text-center table-hover"
                            ...
                            <thead>
                                <tr class="text-white">
                                    ...
                                    <th colspan="3" class="bg-primary">JANUARI</th>
                                    <th colspan="3" class="bg-primary">FEBRUARI</th>
                                    <th colspan="3" class="bg-primary">MARET</th>
                                    <th colspan="3" class="bg-primary">APRIL</th>
                                    <th colspan="3" class="bg-primary">MEI</th>
                                    <th colspan="3" class="bg-primary">JUNI</th>
                                    <th colspan="3" class="bg-primary">JULI</th>
                                    <th colspan="3" class="bg-primary">AGUSTUS</th>
                                    <th colspan="3" class="bg-primary">SEPTEMBER</th>
                                    <th colspan="3" class="bg-primary">OKTOBER</th>
                                    <th colspan="3" class="bg-primary">NOVEMBER</th>
                                    <th colspan="3" class="bg-primary">DESEMBER</th>
                                </tr>
                                <tr class="text-white">
                                    <?php
                                                                    for($i=1;$i<=12;$i++){
                                    ...
                                    <th class="bg-primary" style="z-index: 90">SUDAH BERMITRA</th>
                                    <th class="bg-primary">BELUM BERMITRA</th>
                                    <?php
                                                                    }
                                                                ?>
                                </tr>
