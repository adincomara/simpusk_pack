                        ...
                        <div class="col-lg-6">
                            <div class="ibox ">
                                ...
                                <div class="ibox-content b-r-lg mt-1">
                                    <div class="m-t-md">
                                        <h1 class="text-center font-bold py-2 animated fadeInDown"
                                            style="font-size: 70px;" id="no_antrian">{{ $antrian_now }}</h1>
                                    </div>
                                    <hr>
                                    <div class="row">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <button class="btn btn-primary " type="button" onclick="panggil()" id="panggil_ulang"><i
                                                class="fa fa-bullhorn"></i>&nbsp;Panggil Ulang</button>
            ...
            $.ajax({
                ...
                success: function(data){
                    if(data.success == true){
                        ...
                        let e = new Date(data.pendaftaran.created_at);
                        $('#no_antrian').text(data.antrian.no_antrian);
                        $('#no_rekamedis').text(data.pasien.no_rekamedis);
                        $('#nama_pasien').text(data.pasien.nama_pasien);
                        $('#nik').text(data.pasien.no_ktp);
                        console.log($('#no_rekamedis').text());
                        // $('#waktu_daftar').text(data.pendaftaran.created_at);
                        $('#waktu_daftar').text(addZero(e.getHours())+':'+addZero(e.getMinutes())+':'+addZero(e.getSeconds())+' WIB');
