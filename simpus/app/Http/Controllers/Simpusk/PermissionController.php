...
class PermissionController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request->user()->can('permission.index')) {
            return view('keamanan/modul',['dataObj' => $dataObj]  );
        }
    }

    public function status()
    {
        $value = array('1'=>'Ya' ,'0'=>'Tidak' );
        return $value;
    }
    ...
    public function tambah()
    {
        $status= $this->status();
        $selectedstatus   = '0';
        return view('keamanan_form/modul_form',compact('status','selectedstatus'));
    }
    ...
    public function ubah($enc_id)
    {
      ...
      if ($dec_id) {
        ...
        $selectedstatus   =  $permission->asmenu;
        return view('keamanan_form/modul_form',compact('status','enc_id','selectedstatus','permission'));
      } else {
